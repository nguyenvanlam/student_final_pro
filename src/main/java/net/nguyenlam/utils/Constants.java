...
public class Constants {
	...
	public static String COORD_Y = "coord_y";
	...
	public static String TBL_SEARCH_INFO = "tbl_search_info";
	public static String ID_SEARCH_INFO = "id_search_info";
	public static int COMMON_TYPE_BUILDING = 1;
