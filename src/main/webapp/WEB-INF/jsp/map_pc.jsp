...
<title>UTC Map</title>
 	...
 	<link rel="stylesheet" href='<c:url value="/resources/css/menu_pc.css" />'>
...
<body >
	<div id = "left">
		<jsp:include page="search_pc.jsp"></jsp:include>
		<div style = "padding-left: 20px;">
		<jsp:include page="menu_pc.jsp"></jsp:include>
		</div>
	</div>
	<div id = 'location'>
		<input type="button" onclick="locate()"  class="btn btn-primary btn-lg" value = "Định vị" ></input>
	</div>
	<div id="map" >
	</div>
</body>
